...
<body>
    ...
    <div id="wrapper">
		...
		<!-- feedback-->
		<li><a href="#"><i class="fa fa-user fa-book"></i>Feedback<span class="fa arrow"></span></a>
           <ul class="nav nav-second-level">
                          <li><a href="dashboard.php?info=feedback"><i class="fa fa-eye"></i> Feedback on faculty</a></li >
                          <li><a href="dashboard.php?info=feedback on labs"><i class="fa fa-eye"></i> Feedback on Labs</a></li >
                          <li><a href="dashboard.php?info=feedback on kiet"><i class="fa fa-eye"></i> Feedback on KIET</a></li >
                          <li><a href="dashboard.php?info=feedback_average"><i class="fa fa-eye"></i> Feedback Average</a></li></ul></li>
		<!--feedback end-->
                	...
                	<?php 
								...
								if($info!="")
								{
									...
									elseif($info=="feedback")
                                       ...
                                       elseif($info=="feedback on labs")
                                        {
                                            include('labs.php');


                                        } 
                                         elseif($info=="feedback on kiet")
                                        {
                                            include('feedback on kiet.php');
