<?php
	...
	mysqli_query($conn,"update faculty set Name='$n',designation	='$desg',programme='$prg',semester='$sem',department='$dep',mobile='$mob',	password='$pass' where id='".$_GET['id']."'");	
...
<div class="col-lg-8" style="margin:15px;">
  ...
  <select name="dep" value="<?php echo @$res['department'];?>" class="form-control" required>
                    <option>CSE</option>
                    <option>ECE</option>
                    <option>MECH</option>
                    <option>EEE</option>
